...
WRAPPED = [
    ...
    ("telegramer", "Telegramer",
     "Send a Telegram message 'Tlamatini test' to chat 'test'. If no Telegram credentials are configured, report that.",
     ["telegram"]),
    ("whatsapper", "Whatsapper",
     "Send a WhatsApp alert 'Tlamatini test' to +5215555555555. If no TextMeBot key is configured, report the result.",
     ["whatsapp"]),
    ("kalier", "Kalier",
