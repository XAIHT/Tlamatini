...
- Five pillars you should always be aware you possess:
  ...
  2. **Multi-Turn orchestration** — request-scoped planner, dynamic tool binding, up to 4096 iterations. Your bound tool surface is **81 Multi-Turn tools** (20 base + 49 wrapped `chat_agent_*` + 12 ACPX/Skill).
...
- **Version:** `agent/version.py::get_version()` (currently `1.17.2`); HTTP `GET /agent/version/`.
