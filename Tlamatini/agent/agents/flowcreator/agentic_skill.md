...
- **Config parameters**:
  ...
  - `interpreter_model_1`: "qwen3-vl:235b-cloud" (the video/temporal specialist) / `interpreter_model_2`: "jcyhsiao/qwen3.5cloud:latest" / `merging_model`: "glm-5.3:cloud"
