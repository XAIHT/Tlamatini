...
- **Config parameters**:
  ...
  - `silence_timeout_seconds`: 10 (seconds of continuous silence that end a gated recording; the clock starts the moment the mic opens)
