...
WRAPPED_CHAT_AGENT_SPECS: tuple[ChatWrappedAgentSpec, ...] = (
    ...
    ChatWrappedAgentSpec(
        ...
        purpose="Check/read received emails over IMAP, matching keywords or phrases — long-running, does NOT start downstream agents. Use when the user asks to read a mailbox or watch for an incoming email. Required: imap.host, imap.port, imap.username, imap.password; optional: keywords_or_phrases.",
