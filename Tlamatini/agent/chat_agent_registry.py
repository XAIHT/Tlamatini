...
WRAPPED_CHAT_AGENT_SPECS: tuple[ChatWrappedAgentSpec, ...] = (
    ...
    ChatWrappedAgentSpec(
        ...
        example_request="Send Telegram with mode='send' and contact_name='Ana Ricardo Lazcano' and message='Im ok!'  (contacts.json may keep telegram='@ana_lazcano'; for private @username cold sends, configure Telegram user-session credentials, or have the person press Start/message the bot once so the official Bot API cache can learn them; to receive use mode='receive' and rx_max_seconds=30)",
