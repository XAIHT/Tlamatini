...
WRAPPED_CHAT_AGENT_SPECS: tuple[ChatWrappedAgentSpec, ...] = (
    ...
    ChatWrappedAgentSpec(
        ...
        display_name="Shoter",
        purpose="Take a screenshot of the current screen. Use when the user asks for a screenshot, screen capture, or visual snapshot of what's on screen — also useful as a verification step after launching a desktop application (pair with chat_agent_image_interpreter to read what's on screen).",
