...
WRAPPED_CHAT_AGENT_SPECS: tuple[ChatWrappedAgentSpec, ...] = (
    ...
    ChatWrappedAgentSpec(
        ...
        example_request="Send WhatsApp with mode='send', provider='me' (from my OWN number via WhatsApp Web) and contact_name='<REDACTED>' and message='Im ok!'  -- or provider='cloud' to send from the business number via the official API; omit provider for the cloud default. (web mode needs a one-time QR scan and ignores templates; cloud cold messages need template='hello_world' + template_language='en_US'; use to='+5215555555555' instead of contact_name; to receive use mode='receive' and rx_max_seconds=30)",
