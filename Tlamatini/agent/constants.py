...
MSG_AGENT_READY = "Your agent is ready. You can now start chatting with Tlamatini."
MSG_AGENT_FALLBACK = "There was a problem, so the agent fallback to a Basic Prompt Only Chain (No context is used)."
MSG_OVERSIZED_DOCS_WARNING = "Your agent is ready. But some documents are too large, be aware Tlamatini might not be able to load them completely."
MSG_PROCESSING_REQUEST = "Your request is being processed by Tlamatini. Please wait a moment."
MSG_LLM_CANCELLED = 'Tlamatini generation was cancelled by user. No message will be broadcast. Context will be erased.'
...
MSG_LLM_RECONNECT = "Tlamatini re-connection issued by user. Context will be erased and reconnection has been made."
MSG_LLM_CLEARCONTEXT = "Tlamatini clear-context issued by user. Context will be erased and reconnection has been made."
MSG_LLM_HISTORY_CLEANED = "Chat history has been cleared. Tlamatini agent reconnected successfully."
