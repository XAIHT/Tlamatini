...
_PARAMETRIZER_OUTPUT_FIELDS: dict[str, tuple[str, ...]] = {
    ...
    "whisperer": ("transcript_path", "audio_path", "input_source", "engine", "model", "device", "language", "duration_seconds", "segments", "word_count", "status", "capture_mode", "stop_reason", "silence_timeout_seconds", "speech_seconds", "response_body"),
