...
- A **Visual Agentic Workflow Designer** (ACP) with 71 drag-and-drop agent types
...
- **Agents** — creating a new agent (8-step), naming conventions, lifecycle, all 71 agent types, FlowCreator, FlowHypervisor: @docs/claude/agents.md
