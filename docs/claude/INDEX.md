...
- **agents.md** — 8-step guide for creating a new workflow agent, naming convention transforms, agent lifecycle, connection fields, catalog of all 59 agent types (including TeleTlamatini, WhatsTlamatini, ACPXer), FlowCreator AI skill, FlowHypervisor monitoring.
