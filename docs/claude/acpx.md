...
The 12 tools above are the **LLM-facing** ACPX surface. **ACPXer** is the **canvas-facing** counterpart: a workflow agent (one of the 65 in the visual ACP designer) that drives ONE ACPX session lifecycle from a drag-and-drop node.
