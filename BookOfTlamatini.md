...
2. **Standalone at `C:\Development\ESP32TemplateProject`**, ready to become its own
   ...
   `https://github.com/XAIHT/ESP32TemplateProject`; it has **not been pushed yet**, so
   treat that address as a plan rather than a link.
